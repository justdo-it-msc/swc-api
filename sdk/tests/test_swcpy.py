...
from swcpy.schemas import League, Performance, Player, Team
...
def test_list_performances_by_date():
    ...
    """
    performances_response = client.list_performances(
        skip=0, limit=3000, minimum_last_changed_date="2024-04-01"
    )
